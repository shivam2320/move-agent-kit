...
export class JouleWithdrawTokenTool extends Tool {
  ...
  if you want to withdraw SUPRA, add "0x1::supra_coin::SupraCoin" as mint
  if you want to withdraw token other than SUPRA, you need to provide the mint of that specific token
  if you want to withdraw fungible asset, add "0x1::supra_coin::SupraCoin" as mint and provide fungible asset address
