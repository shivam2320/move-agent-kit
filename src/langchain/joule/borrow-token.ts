...
export class JouleBorrowTokenTool extends Tool {
  ...
  description = `this tool can be used to borrow SUPRA, tokens or fungible asset from a position

  if you want to borrow SUPRA, mint will be "0x1::supra_coin::SupraCoin"
  if you want to borrow token other than SUPRA, you need to provide the mint of that specific token
  if you want to borrow fungible asset, add "0x1::supra_coin::SupraCoin" as mint and provide fungible asset address
